...
class _$UserEntityImpl extends _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, email: $email, displayName: $displayName, photoUrl: $photoUrl, phoneNumber: $phoneNumber, provider: $provider, isEmailVerified: $isEmailVerified, isPremium: $isPremium, premiumExpiryDate: $premiumExpiryDate, createdAt: $createdAt, lastLoginAt: $lastLoginAt)';
  }
